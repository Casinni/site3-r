...
<body>
	...
	<?php
		...
		//$login=$_GET['login'];
	//echo "<div class='alert alert-success' role='alert'> Bienvenue dans la partie private du site ".$login."</div>";
	echo "<div class='alert alert-success' role='alert'> Bienvenue dans la partie private du site ". $_SESSION['login']."</div>";
